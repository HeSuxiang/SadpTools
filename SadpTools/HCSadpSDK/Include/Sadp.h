...
{
    char             szPassword[MAX_PASS_LEN]; //设备admin用户密码
    char             szChannelDefaultPassword[MAX_PASS_LEN]; //要设置的通道默认密码
    unsigned char    byRes[128];
...
CSADP_API void CALLBACK SADP_SetAutoRequestInterval(unsigned int dwInterval); //设置自动搜索时间间隔
